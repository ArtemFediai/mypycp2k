...
def main():
    ...
    parser.add_argument('-i')  # input yaml file
    ...
    bh5670 = input['folder_names']['scratch']  # the outermost folder in the scratch folder where all other data are put
    # other settings
    my_offset = input['molecule_vacuum_offset']
    cutoff = input['cutoff']
    rel_cutoff = input['rel_cutoff']
    basis_set_file_name = input['basis_set_file']
    my_basis_sets = input['basis_set_list']
    my_ri_basis_sets = input['ri_basis_set_list']
    debug = input['debug']
