...
todo: find and change the basis set. What to do with aux basis set? leave as is?
...
from mypycp2k.xc import set_pbe, add_gw_ver_0, add_b3lyp
...
def main():
    ...
    # by default: missing_numbers  #todo: we probably do not need this default. better return an exception!
    try:
    ...
    #todo: this has to be somehow changed depending on the names of files of the GW set
    ...
    for i_bs, suf in enumerate(suffix):
        ...
        b3lyp_diag_simulations = InputFactory.new_b3lyp(i_bs)
