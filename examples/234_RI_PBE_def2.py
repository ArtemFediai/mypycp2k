...
def main():
    ...
    #  main settings
    sim = 'sim_def2_RI'  # simulation folder name
    database_file = 'db_def2_RI'  # database folder
    ...
    cutoff = 500
    rel_cutoff = 50
    basis_set_file_name = 'BASIS_DEF2'  # RI5, 2-5 cc, all aug-cc, RIFIT-all
    my_basis_sets = ['def2-SVPD', 'def2-TZVPD', 'def2-QZVPD']
    # my_ri_basis_sets = ['def2-SVPD-RIFIT', 'def2-TZVPD-RIFIT', 'def2-QZVPPD-RIFIT']
    my_ri_basis_sets = ['def2-QZVPPD-RIFIT', 'def2-QZVPPD-RIFIT', 'def2-QZVPPD-RIFIT']
    ...
    add_ot(SCF, stepsize=0.1)  # stepsize 0.15 (d), 0.05 mol. 100100
    #
